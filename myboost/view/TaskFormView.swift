...
struct TaskFormView: View {
    ...
    @State private var deadline = "Select a date"
    @State private var groupId = "6448ef98f77b520d891024d1"
    ...
    var body: some View {
        ...
        Form {
            ...
            TextField("GitHub Link", text: $gitlink)
                .frame(height: 50)
                .padding(.horizontal)
                .background(Color.white)
                .cornerRadius(10)
                ...
                .sheet(isPresented: $isDatePickerShown) {
                    ...
                    DatePicker("Select a date", selection: $selectedDate, displayedComponents: .date)
                        ...
                        .onChange(of: selectedDate) { newValue in
                            ...
                            deadline = dateFormatter.string(from: newValue)
            ...
            HStack {
                ...
                Button(action: {
                    ...
                    print("status \(status)")
                    print("status lower \(status.lowercased())")
                    viewModel.addTask(name: name, text: text, gitlink: gitlink,assignedto:assignedto, deadline:deadline,groupId: groupId,status: status.lowercased())
                    dismiss()
                    //addTask(name, text, gitlink)
                }) {
                    Text("SAVE TASK")
...
/*struct TaskFormView_Previews: PreviewProvider {
    static var previews: some View {
        TaskFormView(addTask: {_,_,_,_,_,_,_ in })
    }
} */
